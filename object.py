class Game(object):
        ...
        def princess_lives_here(self):
                print "You see a beautiful princess with ashiny crown."
                ...
                if eat_it == "eat it":
                        ...
                        print "She throws the cake at you and it cuts off"
        ...
        def gold_koi_pond(self):
                ...
                print "You peek in and a creepy looking huge Koi startes at you."
                ...
                if feed_it == "feed it ":
                        ...
                        print "You fall in and the Koi shrygs than eats you."
                        ...
                        print "It ruthes to the other end of the pond, braces against the wall..."
        ...
        def bear_with_sword(self):
                print "Puzzled, you are about to pick up the fish poop dimond when"
                print "a bear bearing aload bearing sword walks in."
                print '"Hey! That\' my dimaond! Where\'d you get that!?"'
                print "It holds its paw out and looks at you."

                give_it = raw_input("> ")

                if give_it == "give it":
                        print "The bear swipes at your hand to grab the dimaond and"
                        ...
                        print "It the runs off and now you notice a big iron gate."
        ...
        def big_iron_gate(self):
                ...
                if open_it == "open it":
                        ...
                        print "That doesn't seem sensible.  I mean, the "
                        return 'big_iron_gate'
